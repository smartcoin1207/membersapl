...
const IP4_REGEX =
  '(?!0|10\\.|127\\.|169\\.254\\.|172\\.(?:1[6-9]|2[0-9]|3[0-1])\\.|192\\.0\\.2\\.|192\\.88\\.99\\.|192\\.168\\.|198\\.18\\.|198\\.51\\.100\\.|203\\.0\\.113\\.|224\\.|240\\.|255\\.)(?:25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9]?[0-9])(?:\\.(?:25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9]?[0-9])){3}';
