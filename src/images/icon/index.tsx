...
const iconEmail = require('./IconEmail.png');
const iconPassword = require('./IconPassword.png');
const iconNext = require('./IconNext.png');
const iconLogout = require('./IconLogout.png');
...
const iconRemove = require('./IconRemove.png');
...
const iconDoc = require('./Icondoc.png');
const iconXls = require('./IconXls.png');
...
const iconReply = require('./IconReply.png');
const iconQuote = require('./IconQuote.png');
const iconQuote2 = require('./IconQuote2.png');
